...
+ Библиотека поддерживает две стандартных нотации для описания грамматик EBNF и ABNF. Парсер принимает на вохд исходную строку а возвращает де$
+ Поддерживаются *левосторонние*, *правосторение* и *неоднозначные* граматики.
+ Библиотека расширяет возможности контекстно-свободных грамматик используя PEG-синтаксис с прямым и обратным просмотром входного потока симво$
